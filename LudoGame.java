...
public class LudoGame extends JFrame implements ActionListener 
{
	...
	
	{
		...
		newgame.setBounds(620,520, 210-15, 80);
		add(newgame);
		newgame.setIcon(new ImageIcon("newgame.png"));
		newgame.addActionListener(this);
		dicebutton=new JButton("DICE");
		add(dicebutton);
		dicebutton.setBounds(620,290,103-15,50);
		dicebutton.setIcon(new ImageIcon("Roll.png"));
		dicebutton.addActionListener(this);
		
		label=new JLabel();
		add(label);

		label.setBounds(820-8,285,53,51);
		...
		getRootPane().setDefaultButton(dicebutton);//to set enter key pressing for rolling
	...
	public void paint(Graphics g)
	{
		...
		// 	{
		// 		blank.paintIcon(this, g,i,j);//to fill background with white spaces
		// 	}
		// }
		start=true;
		img2=new ImageIcon("side1.jpg");
		...
		g.setColor(Color.black);//outer frame
	...
	g.fillOval(55, 95,60, 60);
		...
		player11=new ImageIcon("redplayer.png");
	player22=new ImageIcon("redplayer.png");
		player23=new ImageIcon("redplayer.png");
		player14=new ImageIcon("redplayer.png");
		...
		if(player1_1==false)
		{
			...
			player11.paintIcon(this, g, 55+10, 95+10);	
		
		}
		else if(pos11<56)
		{

			player11.paintIcon(this, g, player1xpos[pos11], player1ypos[pos11]);
				if(moves==1 && player1)
				{
		...
		{
			player11.paintIcon(this, g, player1xpos[55]+40, player1ypos[55]-30);
			win11=true;
		}
		...
		player22.paintIcon(this, g, 130+10, 95+10);	
		}
		else  if(pos12<56)
		{
		player22.paintIcon(this, g, player1xpos[pos12], player1ypos[pos12]);
			if(moves==1 && player1)
			{
			g.setColor(Color.orange);
		...
		{
		player22.paintIcon(this, g, player1xpos[55]+40+20, player1ypos[55]);
			win12=true;
		}
		...
		if(player1_3==false)
		{
			...
			player23.paintIcon(this, g, 55+10, 165+10);	
		}
		else  if(pos13<56)
		{
			player23.paintIcon(this, g, player1xpos[pos13], player1ypos[pos13]);
			if(moves==1 && player1)
			{
			g.setColor(Color.orange);
		...
		{
			player23.paintIcon(this, g, player1xpos[55]+40, player1ypos[55]);
			win13=true;
		}
	   ...
	   if(player1_4==false)
		{
			...
			player14.paintIcon(this, g, 130+10, 165+10);	
		}
		else  if(pos14<56)
		{
			player14.paintIcon(this, g, player1xpos[pos14], player1ypos[pos14]);
			if(moves==1 && player1)
			{
			g.setColor(Color.orange);
		...
		{
			player14.paintIcon(this, g, player1xpos[55]+40, player1ypos[55]+25);
			win14=true;
		}
		if(player1 && moves==1 )
		{
		...
		player21=new ImageIcon("greenplayer.png");
		player22=new ImageIcon("greenplayer.png");
		player23=new ImageIcon("greenplayer.png");
		player24=new ImageIcon("greenplayer.png");
		  
		if(player2_1==false)
		{

			
			player21.paintIcon(this, g, 55+10+360, 95+10);	
		}
		else if(pos21<56)
		{
			player21.paintIcon(this, g, player2xpos[pos21], player2ypos[pos21]);
			if(moves==1 && player2)
			{
			g.setColor(Color.orange);
		...
		{
			player21.paintIcon(this, g, player2xpos[55]+30, player2ypos[55]+25);
			win21=true;
		}
	...
	if(player2_2==false)
		{
			...
			player22.paintIcon(this, g, 130+10+360, 95+10);	
		}
		else if(pos22<56)
		{
			player22.paintIcon(this, g, player2xpos[pos22], player2ypos[pos22]);
			if(moves==1 && player2)
			{
			g.setColor(Color.orange);
		...
		else if(pos22>=56)
		{
				...
				player22.paintIcon(this, g, player2xpos[55], player2ypos[55]+25);
				win22=true;
		...
		if(player2_3==false)
		{
			...
			player23.paintIcon(this, g, 55+10+360, 165+10);	
		}
		else if(pos23<56)
		{
			player23.paintIcon(this, g, player2xpos[pos23], player2ypos[pos23]);
			if(moves==1 && player2)
			{
			g.setColor(Color.orange);
		...
		{
			player23.paintIcon(this, g, player2xpos[55], player2ypos[55]+50);
			win23=true;
		}
		...
		if(player2_4==false)
		{
			...
			player24.paintIcon(this, g, 130+10+360, 165+10);	
		}
		else if(pos24<56)
		{
			player24.paintIcon(this, g, player2xpos[pos24], player2ypos[pos24]);
			if(moves==1 && player2)
			{
			g.setColor(Color.orange);
		...
		{
			player24.paintIcon(this, g, player2xpos[55]-25, player2ypos[55]+25);
			win24=true;
		}
		...
		player31=new ImageIcon("yellowplayer.png");
		player32=new ImageIcon("yellowplayer.png");
		player33=new ImageIcon("yellowplayer.png");
		player34=new ImageIcon("yellowplayer.png");
		...
		if(player3_1==false)
		{
			...
			player31.paintIcon(this, g, 55+10+360, 95+10+360);
		
		}
		else if(pos31<56)
		{
			player31.paintIcon(this, g, player3xpos[pos31], player3ypos[pos31]);
			if(moves==1 && player3)
			{
			g.setColor(Color.orange);
		...
		{
				player31.paintIcon(this, g, player3xpos[55]-30, player3ypos[55]+25);
				win31=true;
		}
		...
		if(player3_2==false)
		{
			...
			player32.paintIcon(this, g, 130+10+360, 95+10+360);	
		}
		else if(pos32<56)
		{
			player32.paintIcon(this, g, player3xpos[pos32], player3ypos[pos32]);
			if(moves==1 && player3)
			{
			g.setColor(Color.orange);
		...
		{
			player32.paintIcon(this, g, player3xpos[55]-30, player3ypos[55]-5);
			win32=true;
		}
		...
		if(player3_3==false)
		{
			...
			player33.paintIcon(this, g, 55+10+360, 165+10+360);	
		}
		else if(pos33<56)
		{
			player33.paintIcon(this, g, player3xpos[pos33], player3ypos[pos33]);
			if(moves==1 && player3)
			{
			g.setColor(Color.orange);
		...
		{
			player33.paintIcon(this, g, player3xpos[55]-30, player3ypos[55]-35);
			win33=true;
		}
		...
		if(player3_4==false)
		{
			...
			player34.paintIcon(this, g, 130+10+360, 165+10+360);	
		}
		else if(pos34<56)
		{
			player34.paintIcon(this, g, player3xpos[pos34], player3ypos[pos34]);
			if(moves==1 && player3)
			{
			g.setColor(Color.orange);
		...
		{
			player34.paintIcon(this, g, player3xpos[55]-50, player3ypos[55]-5);
			win34=true;
		}
		if(player3 && moves==1 )
		{
		...
		player41=new ImageIcon("blueplayer.png");
		player42=new ImageIcon("blueplayer.png");
		player43=new ImageIcon("blueplayer.png");
		player44=new ImageIcon("blueplayer.png");
		...
		if(player4_1==false)
		{
			...
			player41.paintIcon(this, g, 55+10, 95+10+360);	
			
		}
		else if(pos41<56)
		{
			
			player41.paintIcon(this, g, player4xpos[pos41], player4ypos[pos41]);
			if(moves==1 && player4)
			{
			g.setColor(Color.orange);
		...
		{
			player41.paintIcon(this, g, player4xpos[55]-25, player4ypos[55]-40);	
			win41=true;
		...
		if(player4_2==false)
		{
			...
			player42.paintIcon(this, g, 130+10, 95+10+360);	
		}
		else  if(pos42<56)
		{
			player42.paintIcon(this, g, player4xpos[pos42], player4ypos[pos42]);
			if(moves==1 && player4)
			{
			g.setColor(Color.orange);
		...
		{
				player42.paintIcon(this, g, player4xpos[55], player4ypos[55]-40);	
				win42=true;
		}
		...
		if(player4_3==false)
		{
			...
			player43.paintIcon(this, g, 55+10, 165+10+360);	
		}
		else if(pos43<56)
		{
			player43.paintIcon(this, g, player4xpos[pos43], player4ypos[pos43]);
			if(moves==1 && player4)
			{
			g.setColor(Color.orange);
			...
			{
					player43.paintIcon(this, g, player4xpos[55]+30, player4ypos[55]-40);	
					win43=true;
			}
		...
		if(player4_4==false)
		{
			...
			player44.paintIcon(this, g, 130+10, 165+10+360);	
		}
		else if(pos44<56)
		{
			player44.paintIcon(this, g, player4xpos[pos44], player4ypos[pos44]);
			if(moves==1 && player4)
			{
			g.setColor(Color.orange);
			...
			{
					player44.paintIcon(this, g, player4xpos[55], player4ypos[55]-70);	
					win44=true;
			}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==runner1&&moves==1)
		{
			...
			if(player1)
			{
				...
				else if(randomnum==6 )//runner1 not true, if u get 6
				{
					player1_1=true;
		...
		if(player1&&moves==0&&e.getSource()==dicebutton)//initial condition when runners are inside
		{
